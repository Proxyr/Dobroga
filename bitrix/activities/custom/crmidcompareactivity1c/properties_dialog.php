...
// $map = $dialog->getMap();
// $EntityGIUD = $map['EntityGUID'];

$currentEntityId = !empty($currentValues['EntityId']) ? $currentValues['EntityId'] : '';
$currentEntityGUID = !empty($currentValues['EntityGUID']) ? $currentValues['EntityGUID'] : '';
...
<tr>
	<td align="right" width="40%">
		<span style="font-weight: bold"><?=GetMessage("CRM_ACTIVITY_LABLE_ENTITY_GUID")?></span>
	</td>
	<td width="60%">

		<?
			// echo $dialog->renderFieldControl($EntityGIUD, null, true, \Bitrix\Bizproc\FieldType::RENDER_MODE_DESIGNER);
		?>
		<?=CBPDocument::ShowParameterField("string", 'EntityGUID', $currentEntityGUID, Array('size'=> 30))?>
	</td>
</tr>
<tr>
	<td align="right" width="40%">
